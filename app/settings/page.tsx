        ...
        <div className="min-h-screen bg-slate-50 font-inter text-slate-900 pb-20">
            ...
            <header className="bg-white border-b border-slate-100 px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <span className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] block leading-none mb-1">Protocol Console</span>
                        <span className="text-sm font-black text-si-navy font-outfit uppercase tracking-tight">Identity & Settings</span>
                    </div>
                </div>
                <button
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-10">
                        ...
                        >
                            ...
                            <div>
                                <h1 className="text-5xl font-black text-si-navy font-outfit tracking-tighter italic mb-6 uppercase leading-none">
                                    Profile <br /> Configuration
                                </h1>
                                <p className="text-slate-500 font-medium leading-relaxed max-w-sm">
                                    Manage your identity and operational parameters within the risk protocol. These details ensure accurate underwriting reports.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Protocol Rights</h3>
                            </div>
                            <div className="bg-slate-50 px-5 py-4 rounded-2xl border border-slate-100 flex items-center justify-between">
                                <span className="text-xs font-black text-si-navy uppercase tracking-tight">
                                    {isAdmin ? "Global Administrator" : "Standard Client"}
                                </span>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="bg-white border border-slate-200 rounded-[48px] p-10 md:p-14 shadow-2xl shadow-slate-200/50 space-y-12">
                                    ...
                                    <div className="flex flex-col gap-6 pt-4">
                                        ...
                                        >
                                            <span className="relative z-10 text-sm">{isSaving ? "Synchronizing Data..." : "Update Protocol Profile"}</span>
